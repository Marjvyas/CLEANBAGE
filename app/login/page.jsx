...
export default function LoginPage() {
  ...
  const handleSubmit = (e) => {
    ...
    const userData = {
      ...
      society: formData.society || "Green Valley Society",
      coins: 150,
      rank: 5,
      activities: [],
    }
  ...
  return (
    <div className="flex min-h-svh flex-col items-center justify-center bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 p-6 md:p-10 relative overflow-hidden">
        ...
        <Card className="overflow-hidden bg-white/90 backdrop-blur-sm border-0 shadow-2xl">
          <CardContent className="grid p-0 md:grid-cols-2">
              ...
              <div className="flex flex-col gap-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h1 className="text-2xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
                    {isLogin ? "Welcome back" : "Join CLEANBAGE"}
                  </h1>
                  <p className="text-balance text-muted-foreground">
                    {isLogin ? "Login to your CLEANBAGE account" : "Create your CLEANBAGE account"}
                  </p>
                </div>
                ...
                <div className="grid gap-2">
                  <div className="flex items-center">
                    ...
                    {isLogin && (
                      <a href="#" className="ml-auto text-sm underline-offset-2 hover:underline text-emerald-600">
            ...
            <div className="relative hidden md:block overflow-hidden">
              <img
                src="/images/eco-globe.jpg"
                alt="Eco-friendly globe in nature"
                className="absolute inset-0 h-full w-full object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-emerald-900/70 via-emerald-800/40 to-transparent"></div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-white p-8 z-10">
                  <h2 className="text-3xl font-bold mb-4 drop-shadow-lg">Smart Waste Management</h2>
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex items-center justify-center space-x-2">
                      ...
                      <span className="drop-shadow-md">Earn EcoCoins for every action</span>
                    </div>
                    <div className="flex items-center justify-center space-x-2">
                      <div className="w-2 h-2 bg-emerald-400 rounded-full shadow-lg"></div>
                      <span className="drop-shadow-md">Compete with your community</span>
                    </div>
                    <div className="flex items-center justify-center space-x-2">
                      <div className="w-2 h-2 bg-emerald-400 rounded-full shadow-lg"></div>
                      <span className="drop-shadow-md">Redeem eco-friendly rewards</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 text-center">
                <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 border border-white/30">
                  ...
                  <span className="text-white/90 text-sm font-medium">50,000+ Active Users</span>
                </div>
              </div>
            </div>
          </CardContent>
